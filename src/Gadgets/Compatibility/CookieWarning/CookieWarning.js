  ...
  var i18nMessages = function i18nMessages() {
    ...
    return {
      ...
      cookieNotice: localize({
        ...
        'zh-hans': '为了提供最佳体验，我们利用Cookie及其他技术提供服务；您可以查阅我们的<a rel="noopener" target="_blank" href="/wiki/LIB:PIPP?consentRead=1" title="个人信息保护方针">个人信息保护条例</a>，了解我们如何处理您的个人信息。',
        'zh-hant': '為了提供最佳體驗，我们利用Cookie及其他技術提供服務；您可以查閱我們的<a rel="noopener" target="_blank" href="/wiki/LIB:PIPP?consentRead=1" title="個人信息保護方針">個人信息保護条例</a>，了解我們如何處理您的個人信息'
      }),
      'I agree': localize({
        ja: '同意する',
        zh: '同意'
