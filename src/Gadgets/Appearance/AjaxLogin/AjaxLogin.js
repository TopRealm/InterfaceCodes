  ...
  var ajaxLoginMain = function ajaxLoginMain() {
    var i18nMessages = function i18nMessages() {
      ...
      return {
        ...
        'If selected, the login status will be kept for 6 个月之前. If not selected, it will be kept for 1 个月之前.': localize({
